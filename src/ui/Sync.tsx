      ...
      {stage === 'done' && (
        <Box flexDirection="column">
          ...
          <Box marginTop={1} flexDirection="column">
            <Text color={theme.muted}>  Target: <Text color={theme.primary}>{options.target}</Text></Text>
            <Text color={theme.muted}>  Mode:   <Text color={theme.primary}>{options.mode}</Text></Text>
          </Box>
            ...
            {steps.map(step => (
              <Box key={step.id} marginLeft={2}>
                <Text color={
                  ...
                  step.status === 'error' ? theme.error :
                  step.status === 'skipped' ? theme.muted :
                  theme.warning
                }>
          ...
          <Box marginTop={1}>
            ...
            {skipped > 0 && <Text color={theme.muted}>  – {skipped} skipped</Text>}
            {errors.length > 0 && <Text color={theme.error}>  ✗ {errors.length} errors</Text>}
          </Box>
